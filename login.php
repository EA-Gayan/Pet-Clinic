...
<div class="header-top">
  <div class="container" >
    ...
    <li class="contact-item">
      ...
      <img src="./images/logo2.png" alt="Italian Trulli" class="logo"style="width:70px;height:40px;margin-right:600px">
        ...
        <div class="form-body">
            ...
            <tr>
                <td>
                    ...
                    <a href="./p-sighnup.php" class="hover-link1 non-style-link">Sign Up</a>
                    <br><br><br>
                </td>
            </tr>      
        </table>
