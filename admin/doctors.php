...
<body>
    ...
    ?>
    <div class="container">
        <div class="menu"style="padding-right: 80px">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord">
                        <a href="patient.php" class="non-style-link-menu"><div><p class="menu-text">Oweners</p></a></div>
                    </td>
                </tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="password" name="password" class="input-text" placeholder="Defind a Password" minlength="8" required><br>
                                </td>
                            </tr><tr>
                                <td class="label-td" colspan="2">
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Conform Password" minlength="8" required><br>
                                        </td>
                                    </tr>
